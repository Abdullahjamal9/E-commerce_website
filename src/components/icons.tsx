/** Shared line-style icons — kept together so every close/remove/delete control looks consistent. */
...
/** Storefront icon — deliberately not shoe-shaped since the catalogue now spans clothes, watches, and more. */
...
export function InfoIcon({ size = 20, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
